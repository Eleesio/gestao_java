...
public class ViewLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(15, 44, 68));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("PDV DOS CRIAS");
        ...
        jPanel2.setBackground(new java.awt.Color(29, 102, 147));
    ...
    // ControllerSeguranca controllerSeguranca = new ControllerSeguranca(); // Comente temporariamente
    ...
    if (controllerUsuario.getValidarUsuarioController(modelUsuario)) {
        modelUsuario = controllerUsuario.getUsuarioController(login);
        
        // Registra login bem-sucedido (comente temporariamente se não implementado)
        // controllerSeguranca.registrarLoginSucesso(modelUsuario);
        
        // Use os setters em vez de atribuir diretamente
        modelSessaoUsuario.setCodigo(modelUsuario.getIdUsuario());
        modelSessaoUsuario.setNome(modelUsuario.getUsuNome());
        modelSessaoUsuario.setLogin(modelUsuario.getUsuLogin());
        
        ViewPrincipal principal = new ViewPrincipal();
        principal.setUsuarioLogado(modelUsuario.getUsuNome());
        principal.setVisible(true);
        
        this.dispose();
    } else {
        // Registra tentativa falha (comente temporariamente)
        // controllerSeguranca.registrarLoginFalha(login);
    ...
    /**
     * Atualiza a data do último login no banco de dados
     */
    private void atualizarUltimoLoginBD(int idUsuario) {
        try {
            controllerUsuario.atualizarDataUltimoLoginController(idUsuario);
        } catch (Exception e) {
            System.err.println("Erro ao atualizar data de login: " + e.getMessage());
